...
static const char col_red1[]        = "#f92672";

static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_blue1, col_gray5, col_gray2 },
	[SchemeSel]  = { col_purple, col_gray6,  col_red1  },
};
...
/* commands */
static const char *dmenucmd[] = { "rofi", "-modes", "combi,drun,run", "-combi-modes", "drun,run,window", "-show", "combi", "-show-icons", NULL  };
